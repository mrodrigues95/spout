...
const STYLES = {
  base: 'p-2 bg-indigo-500 text-white inline-flex justify-center w-12 h-12 items-center shrink-0 font-semibold rounded-100 select-none transition-all duration-75 ease-in-out',
  active:
