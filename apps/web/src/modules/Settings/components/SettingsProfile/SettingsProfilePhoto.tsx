...
import { SettingsProfilePhotoMutation } from '../../../../__generated__/SettingsProfilePhotoMutation.graphql';

const mutation = graphql`
  mutation SettingsProfilePhotoMutation($input: UpdateAvatarInput!) {
...
const SettingsProfilePhoto = ({ ...props }: Props) => {
  ...
  const [updatePhoto, isInFlight] =
    useMutation<SettingsProfilePhotoMutation>(mutation);
