...
const mutation = graphql`
  mutation ProfileMutation($input: UpdateProfileInput!) {
...
const Profile = ({ fetchKey }: Props) => {
  const data = useLazyLoadQuery<ProfileQuery>(query, {}, { fetchKey });
  const [updateProfile, isInFlight] = useMutation<ProfileMutation>(mutation);
