...
import { ChangePhoneNumberMutation } from './__generated__/ChangePhoneNumberMutation.graphql';
import { ChangePhoneNumber_user$key } from './__generated__/ChangePhoneNumber_user.graphql';
...
const EnterVerificationCodeModal = ({
  ...
  const [changePhoneNumber, isChangingPhoneNumber] =
    useMutation<ChangePhoneNumberMutation>(graphql`
      mutation ChangePhoneNumberMutation($input: ChangePhoneNumberInput!) {
...
const ChangePhoneNumber = ({ ...props }: Props) => {
  ...
  return (
    <div className="flex items-center">
      ...
      {me.phoneNumberConfirmed && <RemovePhoneNumber me={me} />}
