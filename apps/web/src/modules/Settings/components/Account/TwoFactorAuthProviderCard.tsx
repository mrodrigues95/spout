...
import { TwoFactorAuthProviderCard_user$key } from './__generated__/TwoFactorAuthProviderCard_user.graphql';
import { TwoFactorAuthProviderCardMutation } from './__generated__/TwoFactorAuthProviderCardMutation.graphql';
...
const DisableTwoFactorAuthenticationModal = () => {
  ...
  const [disableTwoFactor, isInFlight] =
    useMutation<TwoFactorAuthProviderCardMutation>(graphql`
      mutation TwoFactorAuthProviderCardMutation(
...
interface Props {
  me: TwoFactorAuthProviderCard_user$key;
}

const TwoFactorAuthProviderCard = ({ ...props }: Props) => {
...
export default TwoFactorAuthProviderCard;
