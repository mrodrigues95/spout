...
import { ChangeEmail_user$key } from './__generated__/ChangeEmail_user.graphql';
import { ChangeEmailGenerateTokenMutation } from './__generated__/ChangeEmailGenerateTokenMutation.graphql';
...
const mutation = graphql`
  mutation ChangeEmailGenerateTokenMutation(
...
const VerifiedEmailModal = ({
  ...
  const [changeEmail, isInFlight] =
    useMutation<ChangeEmailGenerateTokenMutation>(mutation);
