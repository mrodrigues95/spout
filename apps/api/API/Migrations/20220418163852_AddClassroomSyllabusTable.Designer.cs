...
namespace API.Migrations
{
    ...
    [Migration("20220418163852_AddClassroomSyllabusTable")]
    partial class AddClassroomSyllabusTable
    {
            ...
            modelBuilder.Entity("API.Data.Entities.Classroom", b =>
                {
                    ...
                    b.HasIndex("SyllabusId")
                        .IsUnique()
                        .HasDatabaseName("ix_classrooms_syllabus_id");
            ...
            modelBuilder.Entity("API.Data.Entities.Classroom", b =>
                {
                    ...
                    b.HasOne("API.Data.Entities.ClassroomSyllabus", "Syllabus")
                        .WithOne("Classroom")
                        .HasForeignKey("API.Data.Entities.Classroom", "SyllabusId")
                        .HasConstraintName("fk_classrooms_classroom_syllabus_syllabus_id");
